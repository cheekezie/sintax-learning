...
const Billing = () => {
  const [isPaymentOpen, setIsPamyentOpen] = useState(false);

  const togglePaymentOpen = () => {
    setIsPamyentOpen(!isPaymentOpen);
  };

  return (
    <>
      <PaymentModal isOpen={isPaymentOpen} onClose={togglePaymentOpen} />
      <section>
