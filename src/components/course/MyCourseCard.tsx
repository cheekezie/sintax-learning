...
const MyCourseCard = ({ category, title, lessonsDone, totalLessons, avatars = [] }: prop) => {
  ...
  return (
    <div className={`p-5 rounded-2xl border bg-white relative overflow-hidden flex flex-col justify-between`}>
      <div>
        {/* Category */}
      ...
      <div>
        ...
        <div className='mt-4'>
          ...
          <div className='w-full h-2 bg-secondary/8 rounded-full overflow-hidden'>
